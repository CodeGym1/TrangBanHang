...
@section('content')
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-9">
                <h4 class="h4">Danh sách Đơn Hàng của khách hàng: <strong>{{$customer_id->name}}</strong></h4>
                <table class="table table-bordered table-striped">
                    <tr>
                        <th>Thứ tự</th>
                    ...
                    @foreach($bills as $index=>$bill)
                        <tr>
                            ...
                            <td><a href="{{route('show.edit.bill',$bill->id)}}"><i class="glyphicon glyphicon-edit">Sửa</a> </td>
                            <td><a href="{{route('show.delete.form',$bill->id)}}"><i class="glyphicon glyphicon-trash">Xóa</a> </td>
                        </tr>
                    @endforeach
